 ...
 */
 contract DayDayToken is BurnableToken {
    ...
    {
        lockup = Lockup({lockupTime:720 days,lockupAmount:90000000 * 10 ** 18});
        lockupParticipants[F1] = lockup;
        
        lockup = Lockup({lockupTime:720 days,lockupAmount:60000000 * 10 ** 18});
    ...
    {
        lockup = Lockup({lockupTime:180 days,lockupAmount:90000000 * 10 ** 18});
        lockupParticipants[A1] = lockup;
        
        lockup = Lockup({lockupTime:180 days,lockupAmount:60000000 * 10 ** 18});
        lockupParticipants[A2] = lockup;
        
        lockup = Lockup({lockupTime:180 days,lockupAmount:30000000 * 10 ** 18});
        ...
        lockup = Lockup({lockupTime:180 days,lockupAmount:15000000 * 10 ** 18});
    ...
    {
        lockup = Lockup({lockupTime:90 days,lockupAmount:2500000 * 10 ** 18});
        lockupParticipants[C1] = lockup;
        
        lockup = Lockup({lockupTime:90 days,lockupAmount:1000000 * 10 ** 18});
        lockupParticipants[C2] = lockup;
        
        lockup = Lockup({lockupTime:90 days,lockupAmount:1500000 * 10 ** 18});
        lockupParticipants[C3] = lockup;   
    }
    
    function lockTokensForTeamAndReserve(address team) public onlyOwner
    {
        lockup = Lockup({lockupTime:360 days,lockupAmount:63000000 * 10 ** 18});
        lockupParticipants[team] = lockup;
        
        lockup = Lockup({lockupTime:720 days,lockupAmount:415000000 * 10 ** 18});
